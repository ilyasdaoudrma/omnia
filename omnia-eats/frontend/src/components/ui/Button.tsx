...
const variants: Record<Variant, string> = {
  primary:
    'text-[#fff] shadow-[0_8px_30px_-6px_rgba(234,88,12,0.5)] bg-[linear-gradient(110deg,#c2410c,#ea580c_45%,#f97316)] hover:shadow-[0_10px_40px_-4px_rgba(249,115,22,0.45)]',
