...
/**
 * Light orange-and-green atmosphere — warm orange glows + a green accent on a
...
export const AuroraBackground = memo(function AuroraBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-ink-950">
      ...
      />
      <div className="absolute left-[6%] top-[-12%] h-[52vh] w-[52vh] rounded-full bg-[#ea580c]/14 blur-[130px] animate-aurora-shift" />
      <div className="absolute right-[0%] top-[14%] h-[46vh] w-[46vh] rounded-full bg-[#f97316]/12 blur-[140px] animate-aurora-shift [animation-delay:-6s]" />
      <div className="absolute bottom-[-14%] left-[30%] h-[48vh] w-[48vh] rounded-full bg-[#16a34a]/12 blur-[150px] animate-aurora-shift [animation-delay:-11s]" />
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_55%,rgba(255,248,243,0.9)_100%)]" />
    </div>
  );
});
