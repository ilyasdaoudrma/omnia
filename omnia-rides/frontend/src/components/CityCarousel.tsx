...
/** The six OMNIA cities, each with an editorial tagline. */
const CITIES: City[] = [
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-[15%] z-[2] flex select-none items-center justify-center">
        <span className="font-serif uppercase leading-none text-[#fff]/[0.13]" style={{ fontSize: 'clamp(72px, 22vw, 300px)', letterSpacing: '-0.03em', whiteSpace: 'nowrap' }}>
          {current.name}
        </span>
      </div>
      ...
      <span className="absolute left-5 top-6 z-[60] inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#fff]/85 sm:left-10">
        <MapPin className="h-3.5 w-3.5" /> OMNIA Rides · Choose your city
      </span>
