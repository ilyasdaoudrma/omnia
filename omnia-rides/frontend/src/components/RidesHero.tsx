...
const HERO_IMG = '/rides-hero.webp?v=2';

/** Cinematic full-bleed hero for OMNIA Rides — a luxury car on a coastal road, Ken-Burns + parallax. */
export function RidesHero() {
  const { t } = useT();
  ...
  return (
    <section ref={ref} className="relative h-[100svh] overflow-hidden">
      <motion.div
        style={{
          scale: imgScale,
          backgroundImage: `url('${HERO_IMG}'), radial-gradient(120% 100% at 50% 35%, #0e1a12, #060a07)`,
      ...
      >
        ...
        >
          <Sparkles className="h-3.5 w-3.5" /> OMNIA Rides
        </motion.span>
        ...
        >
          From a Dacia Sandero to a Porsche Cayenne — a driver at your door in seconds,
