...
const variants: Record<Variant, string> = {
  primary:
    'text-[#fff] shadow-[0_8px_30px_-6px_rgba(22,163,74,0.5)] bg-[linear-gradient(110deg,#15803d,#16a34a_45%,#22c55e)] hover:shadow-[0_10px_40px_-4px_rgba(34,197,94,0.45)]',
