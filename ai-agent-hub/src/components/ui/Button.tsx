...
const variants: Record<Variant, string> = {
  primary:
    'text-white shadow-[0_8px_30px_-6px_rgba(212,175,55,0.6)] bg-[linear-gradient(110deg,#9a7b1e,#d4af37_45%,#f1d98a)] hover:shadow-[0_10px_40px_-4px_rgba(241,217,138,0.5)]',
