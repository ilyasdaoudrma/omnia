...
const STRINGS: Record<Locale, Dict> = {
  en: {
    'nav.explore': 'Explore',
    'nav.account': 'My trips',
    'nav.agent': 'Open agent',
    'cta.chooseCity': 'Choose your city',
    'hero.title1': 'Stay somewhere',
    'hero.title2': 'remarkable.',
    'city.heading': 'Where would you like to stay?',
  },
  fr: {
    'nav.explore': 'Explorer',
    'nav.account': 'Mes séjours',
    'nav.agent': "Ouvrir l'agent",
    'cta.chooseCity': 'Choisissez votre ville',
    'hero.title1': 'Séjournez dans un lieu',
    'hero.title2': 'remarquable.',
    'city.heading': 'Où souhaitez-vous séjourner ?',
  },
  ar: {
    'nav.explore': 'استكشف',
    'nav.account': 'رحلاتي',
    ...
    'hero.title1': 'أقم في مكان',
    'hero.title2': 'استثنائي.',
    'city.heading': 'أين تودّ الإقامة؟',
  },
};
