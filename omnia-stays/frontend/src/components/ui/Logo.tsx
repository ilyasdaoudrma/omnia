...
/**
 * OMNIA brand lockup — the gold/silver ring mark plus the wordmark.
 * The mark is a PNG on a black field, so it sits seamlessly on dark surfaces.
 */
    ...
    <span className={cn('flex items-center gap-2.5', className)}>
      <span className={cn('relative block h-9 w-9 shrink-0', imgClassName)}>
        <img
          src="/logo-eye.jpg"
          alt="OMNIA"
          className="absolute inset-0 h-full w-full rounded-full object-cover shadow-[0_2px_10px_-2px_rgba(0,0,0,0.4)]"
          draggable={false}
        />
